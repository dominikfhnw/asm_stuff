...
%if 0
	...
	inc	esi
	pop	edx
	mmap	0, 0xff00, x, x, 0, 0
%elif 1
	;mmap	0x1000000, 0xff00, pop, pop, 0, 0
	;set	ebx, 0xff00
	;set	ecx, 0xff00
	;pop	edx
	;imul	ebx, eax, 127
	;lea	ebx, [4*ecx+esi]
	;mov	bh, 255
	mmap	0xffff, 0xffff, pop, pop, 0, 0
	jmp	eax
	ELF_PHDR
%elif 0
	;mmap	0x1000000, 0xff00, pop, pop, 0, 0
	mmap	0x10000, 0xff00, pop, pop, 0, 0
	ELF_PHDR 1
	jmp	eax
%elif 0
	mmap	0, 0xff00, pop, pop, 0, 0
	jmp	eax
	ELF_PHDR 
%else
	;pop	edi
