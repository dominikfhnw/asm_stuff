true : ;OUT=feat;nasm -I asmlib/ -f bin -o $OUT $0 "$@" && ls -l $OUT && chmod +x $OUT && objdump -b binary -m i386 -D $OUT -z --adjust-vma=0x3d504000 --start-address=0x3d504019 && ./$OUT; echo ret $?; exit
