true : ;nasm -f bin -o crc $0 && ls -l crc && chmod +x crc && objdump -Mintel -b binary -m i386 -D crc  -z --adjust-vma=0x3d400000 --start-address=0x3d40001a && echo && echo "foo" | ./crc; echo ret $?; exit
